                ...
                <table class="cst-table list-table">
                    ...
                    @forelse($list as $row)
                        <tr data-sid="{{ $row->sid }}">
                            ...
                            <td>
                                <a href="javascript:void(0);" class="btn btn-small color-type5 user-login">로그인</a>
                            </td>
                            <td>
                                <a href="javascript:void(0);" class="btn btn-small color-type18 pw-reset">초기화</a>
                            </td>
                            <td>
                                <a href="{{ route('member.modify', ['sid' => $row->sid]) }}"
                                   class="btn-admin btn-modify call-popup" data-width="900" data-height="1200"
                                   data-popup_name="user_modify">
